        ...
        NavigationView {
            List {
                ...
                Section(header: Text("How it works").padding(.leading, 20)) {
                        Text("DeTeXt uses a [MobileNet_v2 PyTorch model](https://pytorch.org/docs/stable/torchvision/models.html#torchvision.models.mobilenet_v2) trained on the [Detexify](http://detexify.kirelabs.org) training data, which was then translated to CoreML using ") +
                        Text("[coremltools](https://coremltools.readme.io)").font(.system(.body, design: .monospaced)) +
                        Text(".\n\nThe symbol images are generated by converting PDF files containing each symbol (made with LaTeX) to SVG files. All symbols are typeset in the default font.\n\nThe source code for DeTeXt is available [on GitHub](https://github.com/venkatasg/DeTeXt) under the MIT License.")
                    }
